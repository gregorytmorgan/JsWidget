 ...
 * @type Class
 */
LiveWidgetTest.LiveWidgetBase = new Class({
    ...
    initialize: function(options) {
		if (options.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(options.name + '::initialize - entry'); }
		...
		this.debug = (options.debug === undefined) ? LiveWidgetTest.LiveWidgetBase.STATE | LiveWidgetTest.LiveWidgetBase.XHR | LiveWidgetTest.LiveWidgetBase.DOM : options.debug;
		...
		for (i = 0, len = urls.length; i < len; i += 1) {
			...
			this.connections[connURL] = new Request({
				...
				'onProgress': function(event, xhr){
					...
					if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':progress - ' + parseInt(loaded / total * 100, 10)); }
				},
				'onComplete': function (response) {
					// note: runs in the context of the Request object
					if (this.debug & (LiveWidgetTest.LiveWidgetBase.XHR)) { console.log(this.name + ':complete - ' + connURL); }
				},
				'onException': (function (headerName, value) {
					if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':exception - ' + connURL); }
					this.errorHandler(connURL);
				}).bind(this),
				'onFailure': (function (xhr) {
					if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':failure - ' + connURL); }
					this.errorHandler(connURL);
				}).bind(this),
				'onTimeout': (function (xhr) {
					if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':timeout - ' + connURL); }
					this.errorHandler(connURL);
				}).bind(this),
				...
				'onCancel': function () {
					// note: runs in the context of the Request object
					if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':cancel - ' + connURL); }
				}
			});
		}
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':initialize - exit'); }
    },
	 ...
	 */
	build: function () {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':build - entry'); }
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':build - exit'); }	
	 ...
	 */
	activate: function () {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':activate - entry'); }	
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':activate - exit'); }	
	},
	 ...
	 */
	deactivate: function () {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':deactivate - entry'); }
		var idx;
		for (idx in this.connections) {
		...
		this.show();		
		if (this.debug & LiveWidgetTest.LiveWidgetBase.STATE) { console.log(this.name + ':deactivate - exit'); }
		return true;
	},
	...
	sendRequest: function (idx) {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':sendRequest - entry'); }
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':sendRequest - exit'); }
	...
	successHandler: function (responseText, responseXML, connURL) {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':successHandler - entry'); }	
		...
		if (this.callbacks.parseResponse && typeof this.callbacks.parseResponse === 'function') {
			try {
				...
				if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':successHandler - parse failed ' + err.message); }
				return false;
			}
		} else {
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':successHandler - exit'); }		
	...
	errorHandler: function (idx) {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':errorHandler - entry'); }
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.XHR) { console.log(this.name + ':errorHandler - exit'); }
	},
	 ...
	 */
	show: function () {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':show - entry'); }		
		var strFail, retval;
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':show - exit'); }
	 ...
	 */
	hide: function () {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':hide - exit'); }
	...
	setText:  function (str) {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':setText - entry'); }
		this.text = str;
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':setText - exit'); }
		return true;
	},
	 ...
	 */
	getText:  function () {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':getText - entry'); }
		return this.text;
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':getText - exit'); }
	},	
	...
	position:  function (oPos) {
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':position - entry'); }
		...
		if (this.debug & LiveWidgetTest.LiveWidgetBase.DOM) { console.log(this.name + ':position - exit'); }
...
LiveWidgetTest.LiveWidgetBase.STATE = 1;

LiveWidgetTest.LiveWidgetBase.XHR = 2;

LiveWidgetTest.LiveWidgetBase.DOM = 4;
